...
{
    /**
     * @var \PHPUnit\Framework\MockObject\MockObject|ProductDefaultCategoryAssignerBusinessFactory
     */
    protected $productDefaultCategoryAssignerBusinessFactoryMock;

    /**
     * @var \PHPUnit\Framework\MockObject\MockObject|\FondOfSpryker\Zed\ProductDefaultCategoryAssigner\Business\Model\DefaultCategoryAssignerInterface
     */
    ...
    /**
     * @var \FondOfSpryker\Zed\ProductDefaultCategoryAssigner\Business\ProductDefaultCategoryAssignerFacade
     */
    ...
    {
        $this->productDefaultCategoryAssignerBusinessFactoryMock->expects($this->atLeastOnce())
            ->method('createDefaultCategoryAssigner')
            ->willReturn($this->defaultCategoryAssignerMock);

        $this->defaultCategoryAssignerMock->expects($this->atLeastOnce())
            ->method('assign')
